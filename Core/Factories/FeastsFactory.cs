...
public partial class FeastsFactory
{
    ...
    public FeastsFactory(DatabaseContext context, ReadingsRepository readingsRepository, ReadingsHelper readingsHelper)
    {
        ...
        [
            ...
            new FeastCalc(Feast.Cross, new LocalDate(1, CopticMonths.Thout, 18, CalendarSystem.Coptic), ConstructFeastOfTheCrossDay2),
            new FeastCalc(Feast.Cross, new LocalDate(1, CopticMonths.Thout, 19, CalendarSystem.Coptic), null),
            ...
            new FeastCalc(Feast.TheophanyParamoun, new LocalDate(1, CopticMonths.Toubah, 10, CalendarSystem.Coptic), null),
            new FeastCalc(Feast.Theophany, new LocalDate(1, CopticMonths.Toubah, 11, CalendarSystem.Coptic), null),
