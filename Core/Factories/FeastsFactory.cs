...
public partial class FeastsFactory
{
    ...
    public FeastsFactory(DatabaseContext context, ReadingsRepository readingsRepository, ReadingsHelper readingsHelper)
    {
        ...
        [
            ...
            new FeastCalc(Feast.Cross, new LocalDate(1, CopticMonths.Thout, 18, CalendarSystem.Coptic), ConstructFeastOfTheCross),
            new FeastCalc(Feast.Cross, new LocalDate(1, CopticMonths.Thout, 19, CalendarSystem.Coptic), ConstructFeastOfTheCross),
