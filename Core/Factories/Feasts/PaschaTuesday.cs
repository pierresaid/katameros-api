        ...
        dayReadings.Sections = new List<Section>() {
            new Section(SectionType.FirstHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.120:2,6,7", "43.8:21-29"),
                }
            },
            new Section(SectionType.ThirdHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.119:154,155", "40.23:37-39*@+40.24:1-2"),
                }
            },
            new Section(SectionType.SixthHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.18:48,17", "43.8:12-20"),
                }
            },
            new Section(SectionType.NinthHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.25:1,2,3", "40.24:3-35"),
                }
            },
            new Section(SectionType.EleventhHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.45:6*@+19.41:1", "40.25:14-46*@+40.26:1-2"),
                }
            },
            new Section(SectionType.EveFirstHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.59:16,17", "40.22:1-14"),
                }
            },
            new Section(SectionType.EveThirdHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.65:4", "40.24:36-51"),
                }
            },
            new Section(SectionType.EveSixthHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.102:1,2", "40.25:1-13"),
                }
            },
            new Section(SectionType.EveNinthHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.22:20-21", "40.23:29-36"),
                }
            },
            new Section(SectionType.EveEleventhHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.57:1", "43.11:55-57"),
                }
            }
        };
        return dayReadings;
