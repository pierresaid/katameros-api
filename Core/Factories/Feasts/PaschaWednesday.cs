        ...
        dayReadings.Sections = new List<Section>() {
            new Section(SectionType.FirstHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.51:4*@+19.33:10", "43.11:46-57"),
                }
            },
            new Section(SectionType.ThirdHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.41:6,1", "42.22:1-6"),
                }
            },
            new Section(SectionType.SixthHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.83:2,5", "43.12:1-8"),
                }
            },
            new Section(SectionType.NinthHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.41:5-6", "40.26:3-16"),
                }
            },
            new Section(SectionType.EleventhHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.6:2*@+19.69:17", "43.12:27-36"),
                }
            },
            new Section(SectionType.EveFirstHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.69:1,16", "43.10:17-21"),
                }
            },
            new Section(SectionType.EveThirdHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.55:21,1", "41.14:3-11"),
                }
            },
            new Section(SectionType.EveSixthHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.140:1,2", "43.12:36-43"),
                }
            },
            new Section(SectionType.EveNinthHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.7:1-2", "43.10:29-38"),
                }
            },
            new Section(SectionType.EveEleventhHour)
            {
                ...
                SubSections = new List<SubSection>() {
                    ...
                    await _readingsRepository.MakePsalmAndGospelLent("19.62:7,6", "43.12:44-50"),
                }
            }
        };
        return dayReadings;
