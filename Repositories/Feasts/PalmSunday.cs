...
namespace Katameros.Repositories
{
    public partial class FeastsRepository
    {
        private async Task<DayReadings> ConstructPalmSunday()
        {
            ...
            liturgy.subSections.Add(await _readingsRepository.MakePsalmAndGospel("19.80:3,1,2", "40.21:1-17"));
            ...
            liturgy.subSections.Add(await _readingsRepository.MakePsalmAndGospel("19.64:1-2", "43.12:12-19"));
